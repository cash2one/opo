...
<html>
 ...
 <body>
 <!---------设置联合关键词  start--------->
         <div id="unionKeyword_management" style="font-family:Microsoft Yahei;">        
           <div style="padding-left:26px;" class="main">                   
           <div>                 
                 <input type="text" id='unionKeyword_serchValue' maxlength="30" placeholder='请输入关键字'>
                 <button style="font-family:Microsoft Yahei;"onclick="serchUnionKeywordList()">搜索</button>
            </div>         	
