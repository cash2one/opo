...
<html>
  ...
  <script type="text/javascript" src="<%=path%>/js/result/HResult.js"></script> 
  <!--===========引入表格插件js================= START ====================-->
 ...
 <button style="font-family:Microsoft Yahei;"onclick="serchHResultList_click()">搜索消息</button>
 ...
 <!--===========时间查询显示列表================= END ====================-->
 <!--===========加载敏感词================= START ====================-->
         <div id="hResult_management" style="font-family:Microsoft Yahei;">        
           <div style="padding-left:26px;" class="main">                   
           <div>                 
                 <!--===========存放模糊查询的div ====================-->    
            </div>         	
           <div id='tableHResult_div' style="float:left;width: 98%;margin-bottom:20px;  margin-left: 10px;" > 
            <table style="" id='tableHResult' class="display" cellspacing="0" width="98%">
             <thead> 
              <tr>            
               <td>关键词</td>   
               <td>创建日期</td>        
